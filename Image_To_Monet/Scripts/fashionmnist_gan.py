...
Original file is located at
    https://colab.research.google.com/drive/1HrGvANeVCdKUBYPCP45vgGq4--lx_wU2

In an effort to understand Generative Adversarial Networks, the first task we 
undertook was a DCGAN implementation with with TensorFlow 2 / Keras, trained with Fashion-MNIST to 
generate gray-scale 28x28x1 images.
It is based on the 'Unsupervised Representation Learning with Deep 
Convolutional Generative Adversarial Networks' paper by Alec, Luke and Soumith and 
the author of the original script is Maynard-Reid, M. “Get Started: DCGAN for 
Fashion-MNIST,” PyImageSearch, 2021, https://pyimagesearch.com/2021/11/11/get-started-dcgan-for-fashion-mnist/. 
